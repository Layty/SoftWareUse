...
/*-------------------------------------------------------------------------
  ...
  -------------------------------------------------------------------------*/
macro AutoExpandInsertSnippet()
{
    var sMacroName; sMacroName = "AutoExpandInsertSnippet"
    var hWnd
    var rSel
    var hBuf
    var sLine
...
/*-------------------------------------------------------------------------
  ...
  -------------------------------------------------------------------------*/
macro AutoExpandCloseAllNonDirtyWindow()
{
...
/*-------------------------------------------------------------------------
  ...
  example, "# " for Python.
  -------------------------------------------------------------------------*/
macro AutoExpandCommentLineOut()
{
    var hWnd; hWnd = GetCurrentWnd()
...
/*-------------------------------------------------------------------------
  ...
  example, "# " for Python.
  -------------------------------------------------------------------------*/
macro AutoExpandUncommentLineOut()
{
    var hWnd; hWnd = GetCurrentWnd()
    var hBuf; hBuf = GetCurrentBuf()
    var rSelOrig; rSelOrig = GetWndSel(hWnd)
...
/*-------------------------------------------------------------------------
  ...
  -------------------------------------------------------------------------*/
macro AutoExpandCommentBlockOut()
{
    var hWnd; hWnd = GetCurrentWnd()
    var hBuf; hBuf = GetCurrentBuf()
    var rSelOrig; rSelOrig = GetWndSel(hWnd)
...
/*-------------------------------------------------------------------------
  ...
  -------------------------------------------------------------------------*/
macro AutoExpandUncommentBlockOut()
{
    var hWnd; hWnd = GetCurrentWnd()
    var hBuf; hBuf = GetCurrentBuf()
    var rSelOrig; rSelOrig = GetWndSel(hWnd)
...
/*-------------------------------------------------------------------------
  ...
  -------------------------------------------------------------------------*/
macro AutoExpandEmacsStyleKeyBinding()
{
    var hBuf; hBuf = GetCurrentBuf()
    var hWnd; hWnd = GetCurrentWnd()
    var rSel; rSel = GetWndSel(hWnd)
...
/*-------------------------------------------------------------------------
  ...
  -------------------------------------------------------------------------*/
macro AutoExpandProgressiveSearch()
{
    var hBuf; hBuf = GetCurrentBuf()
    var hWnd; hWnd = GetCurrentWnd()
    var rSel; rSel = GetWndSel(hWnd)
...
/*-------------------------------------------------------------------------
   ...
   Currently matches [], (), <>, {}
  -------------------------------------------------------------------------*/
macro AutoExpandMatchDelimiter()
{
    var hWnd; hWnd = GetCurrentWnd()
    var hBuf; hBuf = GetCurrentBuf()
    var rSel; rSel = GetWndSel(hWnd)
